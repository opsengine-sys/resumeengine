...
export default function FeedbackModal({ onClose, isDark }: Props) {
  ...
  const handleSubmit = async () => {
    ...
    const payload = {
      areas:         areas.join(', '),  // array → comma-separated string
      feedbackTypes: type,              // → "Feedback Types" column
      details:       message,           // → "Details" column
      email:         email,             // → "Email" column
      // Timestamp is auto-generated by Apps Script
    };
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-6">
            ...
            <div>
              ...
              <div className="flex items-center justify-between mt-1">
                {errors.message
                  ...
                  : <p className="text-xs" style={{ color: muted }}>Be as specific as possible</p>}
            ...
            <div className="rounded-xl p-3 flex items-start gap-2"
              ...
              <p className="text-xs" style={{ color: muted }}>
                <strong style={{ color: accent }}>Privacy:</strong> Your feedback is saved securely. Your email (if provided) will only be used to respond to your feedback.
              </p>
            </div>
          </div>
        )}
          ...
          <div className="flex items-center justify-between px-6 py-4 border-t flex-shrink-0"
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                style={{
                  background: loading ? '#64748b' : 'linear-gradient(135deg,#10b981,#0d9488)',
